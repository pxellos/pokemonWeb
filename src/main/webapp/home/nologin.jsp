...
<c:choose>
	...
	<c:when test="${RESULT == 'nowar' }">
		<h3 align="center">대전을 하려면 로그인 해야만 합니다.</h3>
	</c:when>
	<c:when test="${RESULT == 'nodeck' }">
		<h3 align="center">덱을 보려면 로그인 해야만 합니다.</h3>
	</c:when>
</c:choose>
<form:form modelAttribute="userInfo" action="../login/template.html"
		method="post">
