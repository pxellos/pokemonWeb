...
<body>
	<div class="container-fluid">
		...
		<tr><td align="center" width="100"><font color="black"><b>도감번호</b></font></td> <td align="center"><font color="black"><b>이미지</b></font></td>
			<td align="center" width="110"><font color="black"><b>이름</b></font></td> <td align="center" width="80"><font color="black"><b>Type 1</b></font></td>
			<td align="center" width="80"><font color="black"><b>Type 2</b></font></td> <td align="center" width="120"><font color="black"><b>물리공격력</b></font></td>
			<td align="center" width="120"><font color="black"><b>물리방어력</b></font></td> <td align="center" width="120"><font color="black"><b>특수공격력</b></font></td>
			<td align="center" width="120"><font color="black"><b>특수방어력</b></font></td> <td align="center" width="80"><font color="black"><b>스피드</b></font></td>
			<td align="center" width="80"><font color="black"><b>체력</b></font></td> <td align="center" width="80"><font color="red"><b>총합</b></font></td>
			<td align="center" width="80"><font color="black"><b>가격</b></font></td>
			<td></td> </tr>
			<tbody>	
		<c:forEach items="${pokemonList08}" var="poke">
				<tr>
...
<c:forEach var="page" begin="1" end="${COUNT }">
	<a href="../pokemon/pokemonList08.html?pageNo=${page }">${page }</a>
</c:forEach>
</body>
</html>