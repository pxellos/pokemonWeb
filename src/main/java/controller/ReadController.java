...
//															//포켓몬 도감(능력치)
//	@RequestMapping(value="/read/production.html",method=RequestMethod.GET)
//	public ModelAndView readPokemons(Integer pageNo) {
//		ModelAndView mav = new ModelAndView("home/template");
//		//페이지 갯수를 찾는다.
//		Integer cnt = pokemonCatalog.getPokemonCount();
//		if(cnt == null) cnt = 0;
//		int startRow = 0; 
//		int endRow = 0; 
//		int pageCnt = 0;
...
//		c.setEndRow(endRow);
//		//다섯개의 게시글을 찾는다.(조건 검색)
//		List<PokemonVariety> pokemonList = pokemonCatalog.getPokemons(c);
//		//검색된 결과를 mav에 저장
//		mav.addObject("pokemonList",pokemonList);//검색된 게시글 저장
//		mav.addObject("COUNT",pageCnt);//페이지 갯수 저장
